...
from elk.src.operators.stability_data_bridge_image import Stability
...
@username_option
@password_option
def stability_setup(verbose, username, password):
    logging_utils.initialize_logging(verbose)
    stability_testing = Stability(username, password)
    stability_testing.getStabilityPipelinesData()
